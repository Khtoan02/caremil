...
<body class="bg-brand-cream text-gray-600 font-sans selection:bg-brand-gold selection:text-white">
    ...
    <section id="khoa-hoc" class="py-16 lg:py-24 bg-white relative overflow-hidden">
        <div class="container mx-auto px-4 lg:px-6">
            ...
            <!-- 3.1 WHY CHOOSE (The Explanation) -->
        ...
        <script>
            // --- UPDATED DATA FOR AUTISM CONTEXT ---
            const impactData = {
                normal: {
    ...
    <section id="chuyen-gia" class="py-12 lg:py-20 bg-brand-navy relative overflow-hidden text-white">
        <div class="container mx-auto px-6 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-10">
                <div class="lg:w-1/3">
                    <img src="https://caremil.dawnbridge.vn/wp-content/uploads/2025/12/Care-Milk-tach-nen-scaled.png" class="w-48 lg:w-64 mx-auto drop-shadow-2xl opacity-90 grayscale-[30%] hover:grayscale-0 transition duration-500" alt="CareMIL Expert">
                </div>
        ...
        <div class="container mx-auto px-6 relative z-10">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                <div class="order-1 lg:order-2 lg:w-1/3 relative flex justify-center py-4 lg:py-0 reveal">
                     <div class="absolute inset-0 flex items-center justify-center"><div class="w-48 h-48 lg:w-64 lg:h-64 bg-white rounded-full opacity-60 animate-pulse"></div></div>
                     <img src="https://caremil.dawnbridge.vn/wp-content/uploads/2025/12/Care-Milk-tach-nen-scaled.png" onerror="this.src='https://placehold.co/500x700/e0fbfc/1a4f8a?text=Product&font=baloo2'" alt="CareMIL Product" class="relative z-10 w-40 lg:w-48 xl:w-64 drop-shadow-2xl">
                </div>
