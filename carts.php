...
<body class="bg-gray-50 text-gray-700 font-sans pb-24 pt-20">
    ...
    <nav class="fixed w-full z-50 top-0 bg-white border-b border-gray-100 h-16 flex items-center shadow-sm">
        <div class="container mx-auto px-4 flex justify-between items-center max-w-6xl">
            <a href="caremil_product_list.html" class="flex items-center gap-2 text-gray-500 hover:text-brand-navy font-bold text-sm transition">
            ...
            <div class="md:hidden font-display font-black text-brand-navy text-xl">Giỏ Hàng (2)</div>
        </div>
    </nav>
        ...
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <div class="lg:w-2/3">
                ...
                <div class="space-y-4 mb-8">
                    <!-- Item 1 -->
                    <div class="bg-white rounded-3xl p-4 sm:p-6 border border-gray-100 shadow-sm hover:shadow-md transition duration-300 relative group">
                            ...
                            <div class="flex-grow flex flex-col justify-between py-1">
                                <div>
                                    <div class="flex justify-between items-start">
                                        <h3 class="font-bold text-brand-navy text-base sm:text-xl line-clamp-1"><a href="#" class="hover:text-brand-blue transition">CareMIL Hộp Lớn 800g</a></h3>
                                        <button class="text-gray-300 hover:text-red-500 transition p-1"><i class="fas fa-trash-alt"></i></button>
                                    </div>
                                    <p class="text-xs text-gray-500 mt-1">Phân loại: Hộp thiếc</p>
                                </div>
                                ...
                                <div class="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-3 mt-3">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center bg-gray-50 border border-gray-200 rounded-xl px-2 py-1">
                                            <button onclick="updateCartQty(1, -1)" class="w-7 h-7 flex items-center justify-center text-gray-400 hover:text-brand-navy transition"><i class="fas fa-minus text-[10px]"></i></button>
                                            <input type="number" id="qty-1" value="1" min="1" class="w-8 text-center font-bold text-brand-navy bg-transparent focus:outline-none text-sm" readonly>
                                            <button onclick="updateCartQty(1, 1)" class="w-7 h-7 flex items-center justify-center text-gray-400 hover:text-brand-navy transition"><i class="fas fa-plus text-[10px]"></i></button>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-lg sm:text-xl font-black text-brand-pink">850.000đ</div>
                                        <div class="text-xs text-gray-400 line-through">1.000.000đ</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-3xl p-4 sm:p-6 border border-gray-100 shadow-sm hover:shadow-md transition duration-300 relative group">
                        <div class="flex gap-4 sm:gap-6">
                            ...
                            <div class="flex-grow flex flex-col justify-between py-1">
                                <div>
                                    <div class="flex justify-between items-start">
                                        <h3 class="font-bold text-brand-navy text-base sm:text-xl line-clamp-1"><a href="#" class="hover:text-brand-blue transition">Hộp 10 Gói Tiện Lợi</a></h3>
                                        <button class="text-gray-300 hover:text-red-500 transition p-1"><i class="fas fa-trash-alt"></i></button>
                                    </div>
                                    <p class="text-xs text-gray-500 mt-1">Phân loại: Gói 36g</p>
                                </div>
                                <div class="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-3 mt-3">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center bg-gray-50 border border-gray-200 rounded-xl px-2 py-1">
                                            <button onclick="updateCartQty(2, -1)" class="w-7 h-7 flex items-center justify-center text-gray-400 hover:text-brand-navy transition"><i class="fas fa-minus text-[10px]"></i></button>
                                            <input type="number" id="qty-2" value="2" min="1" class="w-8 text-center font-bold text-brand-navy bg-transparent focus:outline-none text-sm" readonly>
                                            <button onclick="updateCartQty(2, 1)" class="w-7 h-7 flex items-center justify-center text-gray-400 hover:text-brand-navy transition"><i class="fas fa-plus text-[10px]"></i></button>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-lg sm:text-xl font-black text-brand-pink">700.000đ</div>
                                        <div class="text-xs text-gray-400 line-through">900.000đ</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-3xl p-6 shadow-card border border-gray-100 relative overflow-hidden">
                        ...
                        <div class="space-y-3 mb-6">
                            <div class="flex justify-between text-sm text-gray-500">
                                <span>Tạm tính</span>
                                <span class="font-bold text-gray-700">1.550.000đ</span>
                            </div>
                            <div class="flex justify-between text-sm text-gray-500">
                                <span>Giảm giá</span>
                                <span class="font-bold text-green-500">-0đ</span>
                            </div>
                            <div class="flex justify-between text-sm text-gray-500">
                                <span>Vận chuyển</span>
                                <span class="font-bold text-brand-blue">Miễn phí</span>
                            </div>
                            <div class="h-px bg-dashed bg-gray-200 my-2"></div>
                            <div class="flex justify-between items-end">
                                <span class="font-bold text-brand-navy">Tổng thanh toán</span>
                                <span class="text-2xl font-black text-brand-pink">1.550.000đ</span>
                            </div>
                            <p class="text-[10px] text-gray-400 text-right">(Đã bao gồm VAT)</p>
                        </div>

                        <button class="checkout-btn w-full text-white font-bold py-4 rounded-2xl shadow-lg flex items-center justify-center gap-3 text-lg group">
    ...
    <div class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 p-4 md:hidden flex items-center justify-between shadow-[0_-5px_20px_rgba(0,0,0,0.05)] z-40 safe-area-pb">
        <div>
            ...
            <p class="text-lg font-black text-brand-pink">1.550.000đ</p>
        </div>
        <button class="bg-brand-navy text-white font-bold py-2.5 px-8 rounded-xl shadow-lg" onclick="document.querySelector('.checkout-btn').click()">
            Thanh Toán
        </button>
    </div>
