...
<div id="page" class="site min-h-screen flex flex-col">
    <header id="masthead" class="site-header bg-white border-b border-gray-200 shadow-sm">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between py-4 gap-4">
                ...
                <nav id="site-navigation" class="main-navigation">
                    ...
                    wp_nav_menu( array(
                        ...
                        'container'      => false,
                        'fallback_cb'    => false,
                        'link_before'    => '<span class="text-gray-700 hover:text-primary font-medium transition-colors">',
                        'link_after'     => '</span>',
                    ) );
                    ?>
                </nav>
